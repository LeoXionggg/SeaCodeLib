    ...
    public class SysUserService : ISysUserService, IDynamicApiController, ITransient
    {
        ...
        public async Task<dynamic> QueryUserPageList([FromQuery] UserPageInput input)
        {
            ...
            var users = await _sysUserRep.DetachedEntities
                                         ...
                                         .Where(input.SearchStatus >= 0, x => (int)x.n.u.Status == (int)input.SearchStatus)
        ...
        public async Task UpdateUser(UpdateUserInput input)
        {
            ...
            var user = input.Adapt<SysUser>();
            await user.UpdateExcludeAsync(new[] { nameof(SysUser.Password),nameof(SysUser.AdminType) }, true);
