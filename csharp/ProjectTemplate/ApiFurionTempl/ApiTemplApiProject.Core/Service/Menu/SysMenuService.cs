...
namespace ApiTemplApiProject.Core.Service
{
    ...
    public class SysMenuService : ISysMenuService, IDynamicApiController, ITransient
    {
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [HttpGet("/sysMenu/detail")]
        public async Task<dynamic> GetMenu([FromQuery] QueryMenuInput input)
        {
        ...
        /// <summary>
        /// 获取系统右侧菜单树，用于右侧菜单展示（据当前用户角色权限获取）
        /// </summary>
        /// <returns></returns>
        [HttpGet("/sysMenu/get")]
        public async Task<dynamic> GetMenu()
        {
            ...
            return new TreeBuildUtil<SideMenuOutput>().Build(menus);
        }
    }
}
